Module TP4_12_Genero_Queue_Turnos
    ...
    Private Sub SacarTurno(ByRef Clientes As Queue(Of String))
    ...
    Private Sub LlamarProximo(ByRef Clientes As Queue(Of String))
    ...
    Private Function EsVacio(Clientes As Queue(Of String)) As Boolean
