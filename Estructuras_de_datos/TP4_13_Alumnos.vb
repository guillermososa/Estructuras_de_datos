Module TP4_13_Alumnos
    '4.13. Crear un algoritmo con la misma consigna que el
    'ejercicio 4.7 pero utilizando List(of T).
    ...
    Sub Main()
        ...
        Dim Notas As New List(Of Single)
    ...
    Private Sub IngresoAlumno(ByRef Alumnos As List(Of String))
    ...
    Private Function Existe(Alumnos As List(Of String), valor As String) As Boolean
    ...
    Private Function MejoresAlumnos(Promedio() As Single, Alumnos As List(Of String)) As String
